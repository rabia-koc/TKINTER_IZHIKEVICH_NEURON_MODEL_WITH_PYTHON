...
def voice_rec():
    ...
    a1.set_title('Record - Hilbert Method')
...
a = tk.Label(master, text=" Voice Recoder  : ", padx=50, fg="blue", bg="white",
             font="Verdana 15 bold")  # determining the name to enter my time.
a.place(x=27, y=120)

b = tk.Entry(master, width=15, textvariable=record_time, font="Verdana 15 bold")  # where I will enter my time.
b.place(x=28, y=160)

c = tk.Button(master, text="START RECORD", width=15, command=voice_rec, fg="purple",
              font="Verdana 15 bold")  # My button to start my recording.
c.place(x=20, y=200)

d = tk.Button(master, text="RUN IT", width=15, command=func, fg="purple",
              font="Verdana 15 bold")  # The button that makes one of the radiobuttons that I will choose in Izhikevich work.
d.place(x=20, y=665)
